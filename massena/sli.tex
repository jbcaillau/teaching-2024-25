...
% Les quatre travaux de Gaspard Monge
\begin{frame}
\frametitle{\bf Les quatre travaux de Gaspard Monge}

\begin{itemize}
  \item Monge est ne en 1746 et mort en 1818. 
  %\item A 18 ans, Monge s etait fait remarquer en dessinant un plan de sa ville natale de Beaune. N’a-t-on pas oublié de nos jours que la géométrie et le dessin ont des liens intimes ? On lui propose alors de venir travailler à l’École du génie de Mézières, non pas comme élève, mais plutôt comme dessinateur ou assistant préparateur.
  %\item Voici quelques-uns des mathématiciens (entre autres) de son époque : Euler (1707-1783), Gauss (1777-1855)
...
%% 
%% Enfin, la Restauration entraînera sa disgrâce. Il meurt en 1818. (Massena 1817 !)
\end{itemize}
...
\begin{frame}
\frametitle{\bf D\'eblais et remblais}
...
% resultat continuite fig et al (plutot : pb)
% entre terre plate et terre ronde / optimalité 0.29 ?
% dessin lieux injectivité ellip pour mu 1 -> 0
% resultat CRAS
% applications transport : fleur + parrot
% concl : poincaré + transport carré
% caser ex. Williams ? (pas continu)
...
%% - de la terre ronde... à la terre plate
