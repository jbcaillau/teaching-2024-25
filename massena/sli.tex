...
\begin{quote}
"Il n'y a pas des probl\`emes qu'on se pose, il y a des probl\`emes qui se posent. Il n'y a pas de probl\`emes r\'esolus, il y a seulement des probl\`emes plus ou moins r\'esolus". (H. Poincar\é)
\end{quote}
...
\begin{itemize}
  ...
  \item Ghys, E. \emph{Gaspard Monge, mathématicien de la Révolution.} Images des Math\'ematiques, CNRS, 2010
