...
% Le défilement d'une place forte
\begin{frame}
\frametitle{\bf Le défilement d'une place forte}
 
\centering \includegraphics[height=5.0cm]{defil1}

\centering \includegraphics[height=5.0cm]{defil2}
